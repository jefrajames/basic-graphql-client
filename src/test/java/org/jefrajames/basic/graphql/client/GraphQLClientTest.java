...
public class GraphQLClientTest {
    ...
    public static void beforeClass() throws MalformedURLException, IOException {
        ...
        CONFIG.load(GraphQLClientTest.class.getClassLoader().getResourceAsStream("graphql-config.properties"));
    ...
    public void testQueryAllHeroes() {
        ...
        try {
            ...
            Logger.getLogger(GraphQLClientTest.class.getName()).log(Level.SEVERE, null, ex);
            fail();
        }
    ...
    public void testMutationAddHeroToTeam() {
        ...
        String mutation = "mutation addHeroToTeam {addHeroToTeam(hero: \"Starlord\", team: \"Avengers\") {\n"
                + "name\n"
                + "members {\n"
                + "  name\n"
                + "}\n"
        ...
        try {
            Team team = client.execute(mutation, (JsonObject jsonResponse) -> {
    ...
    public void testMutationAddHeroToTeamWithVariables() {
        ...
        String mutation = "mutation addHeroToTeam($heroName:String, $teamName:String) {addHeroToTeam(hero: $heroName, team: $teamName) {\n"
                + "name\n"
                + "members {\n"
                + "  name\n"
                + "}\n"
        ...
        try {
            Team team = client.execute(mutation, variables, (JsonObject jsonResponse) -> {
                JsonObject jsonNewHero = jsonResponse.getJsonObject("addHeroToTeam");
                return jsonb.fromJson(jsonNewHero.toString(), Team.class);
            });
